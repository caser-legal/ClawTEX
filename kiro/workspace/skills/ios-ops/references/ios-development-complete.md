...
### Target Device
iPhone 14: `00008110-00061CD921A3A01E`
...
xcodebuild \
  ...
  -scheme "SchemeName" \
  -destination 'id=00008110-00061CD921A3A01E' \
  build
```
...
devicectl device install app \
  --device 00008110-00061CD921A3A01E \
...
# Build
xcodebuild -scheme AppName -destination 'id=00008110-00061CD921A3A01E' build
```
